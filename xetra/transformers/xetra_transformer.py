...
class XetraSouceConfig(NamedTuple):
    """
    Class for source configuration data
    
    scr_first_extract_date: determines the date for extracting the source
    src_columns: source column names
    src_col_date: column name for date in source
    scr_col_isin: column name for isin in source
...
class XetraETL():
    ...
    def __init__(self, s3_bucket_src: S3BucketConnector,
                 ...
                 src_args: XetraSouceConfig, trg_args: XetraTargetConfig):
        """
